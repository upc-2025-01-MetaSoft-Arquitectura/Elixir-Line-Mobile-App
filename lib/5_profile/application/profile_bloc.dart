...
import 'package:myapp/5_profile/domain/profile_failure.dart';
...
class ProfileBloc extends Bloc<ProfileEvent, ProfileState> {
  ...
  ProfileState _handleProfileResponse(
  ...
  ProfileState _handleUpdateResponse(
    ...
    return failureOrSuccess.fold(
      ...
      (_) {
        ...
        return state.copyWith(
          ...
          updateSuccess: true,
          profile: some(
            currentProfile.copyWith(profilePicture: ProfilePicture(imageUrl)),
          ),
        );
      },
    );
