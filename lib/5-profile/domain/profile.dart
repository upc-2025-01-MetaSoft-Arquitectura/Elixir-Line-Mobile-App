...
abstract class Profile with _$Profile {
  const factory Profile({
    ...
    @JsonKey(name: 'userId') 
    required int userId,
    @JsonKey(name: 'name', fromJson: profileNameFromJson, toJson: profileNameTojson) 
    required ProfileName name,
    @JsonKey(name: 'lastname', fromJson: profileLastNameFromJson, toJson: profileLastNameToJson) 
    required ProfileLastName lastname,
    @JsonKey(name: 'phoneNumber', fromJson: profilePhoneNumberFromJson, toJson: profilePhoneNumberToJson) 
    required ProfilePhoneNumber phoneNumber,
    @JsonKey(name: 'profilePicture', fromJson: profilePictureFromJson, toJson: profilePictureToJson) 
...
ProfilePhoneNumber profilePhoneNumberFromJson(String json) => ProfilePhoneNumber(json);
String profilePhoneNumberToJson(ProfilePhoneNumber object) => object.getOrCrash();
...
ProfileWinegrowerId profileWinegrowerIdFromJson(int json) => ProfileWinegrowerId(json);
int profileWinegrowerIdToJson(ProfileWinegrowerId object) => object.getOrCrash();