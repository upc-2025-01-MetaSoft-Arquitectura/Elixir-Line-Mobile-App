...
import 'package:myapp/1-auth/application/auth_bloc.dart';
import 'package:myapp/1-auth/application/auth_event.dart';
...
class ProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocListener<AuthBloc, AuthState>(
      ...
      child: FutureBuilder<({int? userId, String? email})>(
        future: Future.wait([
