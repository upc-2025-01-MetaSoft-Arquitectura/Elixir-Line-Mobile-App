...
import 'package:myapp/1_auth/application/sign_in_form/sign_in_form_state.dart';
import 'package:myapp/1_auth/domain/auth_failure.dart';
        ...
        return Column(
          ...
          children: [
            TextFormField(
              ...
              autocorrect: false,
              onChanged:
                  (value) => context.read<SignInFormBloc>().add(
