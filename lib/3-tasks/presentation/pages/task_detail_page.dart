...
import 'package:myapp/3-tasks/presentation/widgets/evidence_list.dart';
import 'package:myapp/3-tasks/presentation/widgets/incident_list.dart';
...
class _TaskDetailPageState extends State<TaskDetailPage> {
  ...
  void initState() {
    ...
    _incidentBloc.add(IncidentsFetched(taskId: widget.task.id, taskType: widget.task.type));
  }
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [
            ...
            IncidentList(taskId: widget.task.id),
          ],
        ),
      ),
    );
